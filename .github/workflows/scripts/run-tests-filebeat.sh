...
for _ in $(seq 1 30); do
	response="$(curl "http://${ip_es}:9200/filebeat-*/_search?q=input.type:%22docker%22%20AND%20docker.container.name:%22docker-elk-elasticsearch-1%22&pretty" -s -u elastic:testpasswd)"
