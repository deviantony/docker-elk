...
#   AND docker.container.name:"docker-elk_elasticsearch_1"
#
...
for _ in $(seq 1 30); do
	response="$(curl "http://${ip_es}:9200/metricbeat-*/_search?q=event.dataset:%22docker.container%22%20AND%20docker.container.name:%22docker-elk_elasticsearch_1%22&pretty" -s -u elastic:testpasswd)"
